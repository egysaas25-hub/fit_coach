...
const navigation = [
  ...
  { name: "Analytics", href: "/admin/analytics/overview", icon: BarChart3, section: "Overview" },
  { name: "Reports", href: "/admin/reports", icon: FileText, section: "Overview" },
  
  { name: "All Clients", href: "/admin/clients", icon: ShoppingCart, section: "Users" },
  // Removed invalid dynamic route: { name: "Client Details", href: "/admin/clients/[id]", icon: User, section: "Users" },
  { name: "Teams Dashboard", href: "/admin/teams", icon: Users2, section: "Users" },
  ...
  { name: "Workouts", href: "/admin/workouts", icon: Dumbbell, section: "Plans" },
  { name: "Nutrition Plans", href: "/admin/nutrition", icon: Target, section: "Plans" },
  { name: "Custom Exercises", href: "/admin/exercises/custom", icon: Table, section: "Plans" },
  { name: "Exercise Library", href: "/admin/exercises/library", icon: Table, section: "Plans" },
  ...
  { name: "Workflows", href: "/admin/automation/workflows", icon: Zap, section: "Automation" },
  { name: "AI Logs", href: "/admin/ai/logs", icon: FileText, section: "Automation" },
  { name: "AI Templates", href: "/admin/ai/templates", icon: Table, section: "Automation" },
  ...
  { name: "General Settings", href: "/admin/settings/general", icon: Settings, section: "System" },
]
