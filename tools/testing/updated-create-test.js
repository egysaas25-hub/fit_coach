// Updated test creating records in the database with proper tenant ID
const { PrismaClient } = require('@prisma/client');

const prisma = new PrismaClient();

async function testCreateRecords() {
  console.log('Starting updated record creation test...\n');
  ...
  try {
    ...
    // Clean up by deleting the created records (in reverse order due to foreign key constraints)
